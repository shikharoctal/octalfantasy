...
class PHOTPTextField: UITextField
{
    ...
    var borderColor_: UIColor = UIColor.attributedTextColor
    
    /// Border width info for field
    var borderWidth_: CGFloat = 2
    ...
    func initalizeUI(forFieldType type: DisplayType)
    {
        ...
        textColor = UIColor.cellUnselectedColor
    }
    ...
    fileprivate func addDiamondMask()
    {
        ...
        shapeLayer.strokeColor = borderColor_.cgColor
