...
public struct PinConfig
{
    ...
    var otpFieldFont: UIFont = UIFont(name: "Gilroy-Medium", size: 18.0)!
    ...
    init(otpFieldDisplayType: DisplayType = DisplayType.circular,
         ...
         otpFieldFont: UIFont = UIFont(name: "Gilroy-Medium", size: 18.0)!,
         ...
         otpFieldDefaultBackgroundColor: UIColor = UIColor(white: 1, alpha: 0.5),
         otpFieldEnteredBackgroundColor: UIColor = UIColor(white: 1, alpha: 0.5),
         otpFieldDefaultBorderColor: UIColor = UIColor.appHighlightedTextColor,
         otpFieldEnteredBorderColor: UIColor = UIColor.appHighlightedTextColor,
         otpFieldErrorBorderColor: UIColor = UIColor.appRedColor
    )
    {
